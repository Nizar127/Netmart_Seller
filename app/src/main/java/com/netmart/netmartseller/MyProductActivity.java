...
//        });
    ...
    protected void onStart() {
        ...
        Query query = my_productRef.collection("Products").orderBy("name", Query.Direction.ASCENDING);
...
//        Query query = my_productRef.orderBy("timestamp", Query.Direction.ASCENDING);
//
//        FirestoreRecyclerOptions<Products> options = new FirestoreRecyclerOptions.Builder<Products>()
//                .setQuery(query, Products.class)
//                .build();
//
//        productList = new ProductListAdapter(options);
